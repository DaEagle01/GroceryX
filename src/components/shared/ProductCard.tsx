...
const ProductCard = ({ product, heroProduct }: { product: Product, heroProduct?: boolean }) => {
    return (
        <div className="relative rounded-xl border-green-300 flex flex-col justify-between ">
