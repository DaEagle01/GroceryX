...
const TopCategories = () => {
    ...
    return (
        <div className="max-w-[90rem] mx-auto px-4 lg:px-20 pb-20 sm:pb-[170px]">
            <div className="flex flex-col items-center justify-center gap-3 mb-8 sm:mb-[68px]">
                <h1 className="text-2xl sm:text-4xl font-bold text-gray-800">
                    Top Categories
                </h1>
                <h6 className="text-base font-normal text-gray-600 max-w-[90%] sm:max-w-[45%] text-center">
                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam.
                </h6>
            </div>
            <div className="grid grid-cols-12 gap-4 sm:gap-8">
                {categories.map(item => (
                    <Link href={`/fishes?category=${item.path}`} key={item.category} className="col-span-6 sm:col-span-4 border rounded-xl h-[240px] relative flex flex-col items-center">
                        <div className="w-[100%] sm:w-[392px] h-[80%] relative overflow-y-hidden">
